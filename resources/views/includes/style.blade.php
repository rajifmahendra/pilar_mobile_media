...
<link rel="apple-touch-icon" sizes="72x72"
    href="{{ asset('template/html/images/favicon/apple-touch-icon-72x72.png') }}">
<link rel="apple-touch-icon" sizes="114x114" href="{{ asset('') }}images/favicon/apple-touch-icon-114x114.png"> --}}
<!-- CSS -->
<!-- REVOSLIDER CSS SETTINGS -->
<link rel="stylesheet" type="text/css" href="{{ asset('template/html/rs-plugin/css/settings.min.css') }}"
    media="screen" />
<!--  BOOTSTRAP -->
